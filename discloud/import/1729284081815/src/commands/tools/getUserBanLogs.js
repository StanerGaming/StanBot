    ...
    async execute(interaction, client){
      ...
      /*  async function callApi() {
        ...
        if (interaction.member.roles.cache.has('1039289552302514257')){ 
           ...
           if (pagetoken)  {
            const response =await Axios.get(`https://apis.roblox.com/cloud/v2/universes/${botinfo.Roblox_Token}/user-restrictions:listLogs?maxPageSize=1&pageToken=${pagetoken}&filter=user == 'users/${usertoSearchFor}'`, {
                headers:{
            ...
            const response =await Axios.get(`https://apis.roblox.com/cloud/v2/universes/${botinfo.Roblox_Token}/user-restrictions:listLogs?maxPageSize=1&filter=user == 'users/${usertoSearchFor}'`, {
                headers:{
                'x-api-key': botinfo.Roblox_Key
                }
       ...
       //const userID = ((/robloxUser": "users\/(.+\d)/gm).exec(text))
        //const highlighted = discordjs.codeBlock('json', text);
        const newMessage = `User: ${UserName}\nNext page: ${sally.nextPageToken}  `/*`Signal Sent,
